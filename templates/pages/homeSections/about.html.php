            ...
            <div class="bloc3">
                <svg width="44" height="59" viewBox="0 0 44 59" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M21.9141 29.4998C21.9141 24.0691 26.8198 19.6665 32.8715 19.6665C38.923 19.6665 43.8289 24.0691 43.8289 29.4998C43.8289 34.9307 38.923 39.3332 32.8715 39.3332C26.8198 39.3332 21.9141 34.9307 21.9141 29.4998Z"
                          fill="#A172F9"/>
                    <path d="M0 49.1666C0 43.7359 4.9058 39.3333 10.9574 39.3333H20.9148C21.4671 39.3333 21.9148 39.781 21.9148 40.3333V49.1666C21.9148 54.5974 17.0091 58.9999 10.9574 58.9999C4.9058 58.9999 0 54.5974 0 49.1666Z"
                          fill="#A172F9"/>
                    <path d="M22.9141 0C22.3618 0 21.9141 0.447715 21.9141 1V18.6666C21.9141 19.2189 22.3618 19.6666 22.9141 19.6666H32.8715C38.9231 19.6666 43.8289 15.2641 43.8289 9.83333C43.8289 4.40254 38.9231 0 32.8715 0H22.9141Z"
                          fill="#A172F9"/>
                    <path d="M0 9.83333C0 15.2641 4.9058 19.6666 10.9574 19.6666H20.9148C21.4671 19.6666 21.9148 19.2189 21.9148 18.6666V1C21.9148 0.447715 21.4671 0 20.9148 0H10.9574C4.9058 0 0 4.40253 0 9.83333Z"
                          fill="#A172F9"/>
                    <path d="M0 29.4998C0 34.9307 4.9058 39.3332 10.9574 39.3332H20.9148C21.4671 39.3332 21.9148 38.8855 21.9148 38.3332V20.6665C21.9148 20.1142 21.4671 19.6665 20.9148 19.6665H10.9574C4.9058 19.6665 0 24.0691 0 29.4998Z"
                          fill="#A172F9"/>
                </svg>
                <p>UI - Figma</p>
